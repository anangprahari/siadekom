                    ...
                    <div class="card-header bg-gradient-blue text-white">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                ...
                                <div class="text-white text-opacity-75 small">Nomor identifikasi dan spesifikasi teknis
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card-header bg-gradient-blue text-white">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                ...
                                <div class="text-white text-opacity-75 small">Informasi asal perolehan dan kondisi barang
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-md-6">
                                <div class="detail-item">
                                    ...
                                    <div class="detail-value">
                                        <span
                                            class="badge bg-{{ $aset->keadaan_barang === 'B' ? 'success' : ($aset->keadaan_barang === 'KB' ? 'warning' : 'danger') }} fs-6 px-3 py-2">
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-md-4">
                                <div class="detail-item">
                                    ...
                                    <div class="detail-value">
                                        <span
                                            class="fw-bold text-success font-mono">{{ $aset->formatted_total_harga }}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="hierarchy-level level-1">
                                    ...
                                    <div class="hierarchy-content">
                                        ...
                                        <div class="hierarchy-name">
                                            {{ $aset->subSubRincianObjek->subRincianObjek->rincianObjek->objek->jenis->kelompok->akun->nama }}
                                        </div>
                                        <div class="hierarchy-code">
                                            {{ $aset->subSubRincianObjek->subRincianObjek->rincianObjek->objek->jenis->kelompok->akun->kode }}
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="hierarchy-item">
                                <div class="hierarchy-level level-2">
                                    ...
                                    <div class="hierarchy-content">
                                        ...
                                        <div class="hierarchy-name">
                                            {{ $aset->subSubRincianObjek->subRincianObjek->rincianObjek->objek->jenis->kelompok->nama }}
                                        </div>
                                        <div class="hierarchy-code">
                                            {{ $aset->subSubRincianObjek->subRincianObjek->rincianObjek->objek->jenis->kelompok->kode }}
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="hierarchy-item">
                                <div class="hierarchy-level level-3">
                                    ...
                                    <div class="hierarchy-content">
                                        ...
                                        <div class="hierarchy-name">
                                            {{ $aset->subSubRincianObjek->subRincianObjek->rincianObjek->objek->jenis->nama }}
                                        </div>
                                        <div class="hierarchy-code">
                                            {{ $aset->subSubRincianObjek->subRincianObjek->rincianObjek->objek->jenis->kode }}
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="hierarchy-item">
                                <div class="hierarchy-level level-4">
                                    ...
                                    <div class="hierarchy-content">
                                        ...
                                        <div class="hierarchy-name">
                                            {{ $aset->subSubRincianObjek->subRincianObjek->rincianObjek->objek->nama }}
                                        </div>
                                        <div class="hierarchy-code">
                                            {{ $aset->subSubRincianObjek->subRincianObjek->rincianObjek->objek->kode }}
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="hierarchy-item">
                                <div class="hierarchy-level level-5">
                                    ...
                                    <div class="hierarchy-content">
                                        ...
                                        <div class="hierarchy-name">
                                            {{ $aset->subSubRincianObjek->subRincianObjek->rincianObjek->nama }}</div>
                                        <div class="hierarchy-code">
                                            {{ $aset->subSubRincianObjek->subRincianObjek->rincianObjek->kode }}</div>
                                    </div>
                                </div>
                            </div>
                            <div class="hierarchy-item">
                                <div class="hierarchy-level level-6">
                                    ...
                                    <div class="hierarchy-content">
                                        ...
                                        <div class="hierarchy-name">{{ $aset->subSubRincianObjek->subRincianObjek->nama }}
                                        </div>
                                        <div class="hierarchy-code">{{ $aset->subSubRincianObjek->subRincianObjek->kode }}
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="asset-image-container position-relative">
                                ...
                                <div class="image-overlay">
                                    <div class="image-overlay-content">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-lg text-white mb-2"
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body p-0">
                    <img id="modalImage" src="" alt="Asset Image" class="w-100"
