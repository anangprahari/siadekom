...
<body>
    <div class="container-fluid main-container">
        <div class="form-container">
            ...
            <form id="assetForm" method="POST" action="{{ route('asets.update', $aset->id) }}"
                        ...
                        <div class="col-md-4 mt-3">
                            <div class="dropdown-item">
                                ...
                                <select class="form-select" id="sub_sub_rincian_objek"
                                    name="sub_sub_rincian_objek_id" required>
                    ...
                    <div id="hierarchy-content">
                        @if (!empty($selectedHierarchy))
                            @foreach ($selectedHierarchy as $key => $item)
                                @if ($item)
                                    <div class="hierarchy-item"><span
                                            class="hierarchy-level">{{ ucfirst(str_replace('_', ' ', $key)) }}:</span>
                                        {{ $item->nama ?? $item->nama_barang }}</div>
                                @endif
                            @endforeach
                        @endif
                    </div>
                ...
                <div class="kode-preview fade-in" id="kode-preview"
                    ...
                    <i class="fas fa-barcode"></i> Kode Barang: <span
                        id="kode-barang-text">{{ old('kode_barang', $aset->kode_barang) }}</span>
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                <label class="form-label">Nama Bidang Barang <span
                                        class="required-field">*</span></label>
                                <input type="text" class="form-control" name="nama_bidang_barang"
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="register"
                                    value="{{ old('register', $aset->register) }}" required
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="satuan"
                                    value="{{ old('satuan', $aset->satuan) }}" required
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control" name="harga_satuan" min="0"
                                    step="0.01" value="{{ old('harga_satuan', $aset->harga_satuan) }}" required
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="bahan"
                                    value="{{ old('bahan', $aset->bahan) }}" placeholder="Masukkan bahan barang">
                            </div>
                        </div>
                                ...
                                @if ($aset->bukti_barang_path)
                                    <div class="mt-2">
                                        <small class="text-muted">File saat ini: <a
                                                href="{{ Storage::url($aset->bukti_barang_path) }}"
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                @if ($aset->bukti_berita_path)
                                    <div class="mt-2">
                                        <small class="text-muted">File saat ini: <a
                                                href="{{ Storage::url($aset->bukti_berita_path) }}"
                                                target="_blank">Lihat File</a></small>
                                    </div>
                                @endif
                            </div>
