                ...
                <div class="col">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            ...
                            <div class="text-muted mt-1">Informasi lengkap aset lancar {{ $asetLancar->nama_kegiatan }}
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row g-4">
                            <div class="col-md-6">
                                <div class="detail-item">
                                    ...
                                    <div class="detail-value font-mono">{{ $asetLancar->rekeningUraian->kode_rekening }}
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="detail-item">
                                    ...
                                    <div class="detail-value font-mono">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="icon me-2 text-muted" width="20"
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="text-center" style="background-color: #f0f9ff;">
                                            <span
                                                class="badge bg-cyan text-white">{{ number_format($asetLancar->saldo_awal_unit) }}</span>
                                        </td>
                                        ...
                                        <td class="text-center" style="background-color: #f0fdf4;">
                                            @if ($asetLancar->mutasi_tambah_unit > 0)
                                                <span
                                                    class="badge bg-success">+{{ number_format($asetLancar->mutasi_tambah_unit) }}</span>
                                            @else
                                        ...
                                        <td class="text-center" style="background-color: #fef2f2;">
                                            @if ($asetLancar->mutasi_kurang_unit > 0)
                                                <span
                                                    class="badge bg-danger">-{{ number_format($asetLancar->mutasi_kurang_unit) }}</span>
                                            @else
                                                <span class="text-muted">-</span>
                                            @endif
                                        </td>
                                        <td class="text-end" style="background-color: #fef2f2;">
                                            @if ($asetLancar->mutasi_kurang_nilai_total > 0)
                                                <span class="text-danger fw-bold">Rp
                                                    {{ number_format($asetLancar->mutasi_kurang_nilai_total, 0, ',', '.') }}</span>
                                            @else
                                                <span class="text-muted">-</span>
                                            @endif
                                        </td>
                                        <td class="text-center" style="background-color: #fffbeb;">
                                            <span
                                                class="badge bg-warning text-dark">{{ number_format($asetLancar->saldo_akhir_unit) }}</span>
                                        </td>
                                        <td class="text-end" style="background-color: #fffbeb;">
                                            <span class="fw-bold text-primary fs-5">Rp
                                                {{ number_format($asetLancar->saldo_akhir_total, 0, ',', '.') }}</span>
                                        </td>
                                    </tr>
                                </tbody>
                                ...
                                <div class="calculation-box">
                                    ...
                                    <div class="calculation-item mb-3">
                                        ...
                                        <div class="calculation-formula">
                                            <code>{{ number_format($asetLancar->saldo_awal_unit) }} unit × Rp
                                                {{ number_format($asetLancar->saldo_awal_harga_satuan, 0, ',', '.') }} = Rp
                                                {{ number_format($asetLancar->saldo_awal_total, 0, ',', '.') }}</code>
                                        </div>
                                    </div>
                                    <div class="calculation-item">
                                        <label class="calculation-label">Mutasi Tambah Total</label>
                                        <div class="calculation-formula">
                                            <code>{{ number_format($asetLancar->mutasi_tambah_unit) }} unit × Rp
                                                {{ number_format($asetLancar->mutasi_tambah_harga_satuan, 0, ',', '.') }} =
                                                Rp
                                                {{ number_format($asetLancar->mutasi_tambah_nilai_total, 0, ',', '.') }}</code>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="calculation-box">
                                    ...
                                    <div class="calculation-item mb-3">
                                        ...
                                        <div class="calculation-formula">
                                            <code>{{ number_format($asetLancar->saldo_awal_unit) }} +
                                                {{ number_format($asetLancar->mutasi_tambah_unit) }} -
                                                {{ number_format($asetLancar->mutasi_kurang_unit) }} =
                                                {{ number_format($asetLancar->saldo_akhir_unit) }} unit</code>
                                        </div>
                                    </div>
                                    <div class="calculation-item">
                                        ...
                                        <div class="calculation-formula">
                                            @php
                                                $harga_satuan_akhir =
                                                    $asetLancar->saldo_awal_harga_satuan > 0
                                                        ? $asetLancar->saldo_awal_harga_satuan
                                                        : $asetLancar->mutasi_tambah_harga_satuan;
                                            @endphp
                                            <code>{{ number_format($asetLancar->saldo_akhir_unit) }} unit × Rp
                                                {{ number_format($harga_satuan_akhir, 0, ',', '.') }} = Rp
                                                {{ number_format($asetLancar->saldo_akhir_total, 0, ',', '.') }}</code>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="card-body p-4">
                        <div class="summary-item mb-3">
                            <div class="d-flex justify-content-between align-items-center mb-2">
                                ...
                                <span class="summary-value text-info fw-bold">Rp
                                    {{ number_format($asetLancar->saldo_awal_total, 0, ',', '.') }}</span>
                            </div>
                        ...
                        <div class="summary-item mb-3">
                            <div class="d-flex justify-content-between align-items-center mb-2">
                                ...
                                <span class="summary-value text-success fw-bold">Rp
                                    {{ number_format($asetLancar->mutasi_tambah_nilai_total, 0, ',', '.') }}</span>
                            </div>
                            <div class="progress progress-sm">
                                <div class="progress-bar bg-success"
                                    style="width: {{ $asetLancar->mutasi_tambah_nilai_total > 0 ? '100' : '0' }}%"></div>
                            </div>
                        </div>
                        <div class="summary-item mb-3">
                            <div class="d-flex justify-content-between align-items-center mb-2">
                                <span class="summary-label">Mutasi Kurang</span>
                                <span class="summary-value text-danger fw-bold">Rp
                                    {{ number_format($asetLancar->mutasi_kurang_nilai_total, 0, ',', '.') }}</span>
                            </div>
                            <div class="progress progress-sm">
                                <div class="progress-bar bg-danger"
                                    style="width: {{ $asetLancar->mutasi_kurang_nilai_total > 0 ? '100' : '0' }}%"></div>
                            </div>
                        </div>
                        <hr class="my-4">
                        <div class="summary-item mb-3">
                            <div class="d-flex justify-content-between align-items-center mb-2">
                                ...
                                <span class="summary-value text-primary fw-bold fs-4">Rp
                                    {{ number_format($asetLancar->saldo_akhir_total, 0, ',', '.') }}</span>
                            </div>
                            <div class="progress progress-sm">
                        ...
                        @php
                            ...
                            if ($asetLancar->saldo_awal_total > 0) {
                                $persentasePerubahan =
                                    (($asetLancar->saldo_akhir_total - $asetLancar->saldo_awal_total) /
                                        $asetLancar->saldo_awal_total) *
                                    100;
                            }
                        @endphp
                            ...
                            <div class="timeline-item">
                                ...
                                <div class="timeline-content">
                                    ...
                                    <p class="timeline-description mb-1">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-sm me-2 text-primary"
                                            width="16" height="16" viewBox="0 0 24 24" stroke-width="2"
                                            stroke="currentColor" fill="none" stroke-linecap="round"
                                            stroke-linejoin="round">
                                            <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                            ...
                            @if ($asetLancar->created_at != $asetLancar->updated_at)
                                <div class="timeline-item">
                                    ...
                                    <div class="timeline-content">
                                        ...
                                        <p class="timeline-description mb-1">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-sm me-2 text-warning"
                                                width="16" height="16" viewBox="0 0 24 24" stroke-width="2"
                                                stroke="currentColor" fill="none" stroke-linecap="round"
                                                stroke-linejoin="round">
                                                <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
