                ...
                <div class="col">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            ...
                            <div class="text-muted mt-1">Kelola dan pantau seluruh aset lancar yang tercatat dalam sistem
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="card-body">
                <form method="GET" action="{{ route('aset-lancars.index') }}">
                    <div class="row g-2 align-items-end">
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="search" id="search" class="form-control"
                                    placeholder="Cari berdasarkan nama kegiatan, uraian, jenis barang..."
                                    value="{{ request('search') }}">
                            </div>
                        </div>

                        <div class="col-md-6">
                            <label for="rekening_uraian_id" class="form-label fw-bold text-blue mb-1">Rekening
                                Uraian</label>
                        ...
                        <div class="col-md-6">
                            <label class="form-label fw-bold text-blue mb-1">Rentang Tanggal</label>
                            <div class="row g-2">
                                <div class="col-6">
                        ...
                        <div class="col-md-6">
                            <label class="form-label fw-bold text-blue mb-1">Rentang Saldo Awal</label>
                            <div class="row g-2">
                                <div class="col-6">
                                    <input type="number" name="saldo_awal_min" id="saldo_awal_min" class="form-select"
                                        placeholder="Minimum" value="{{ request('saldo_awal_min') }}">
                                </div>
                                <div class="col-6">
                                    <input type="number" name="saldo_awal_max" id="saldo_awal_max" class="form-select"
                                        placeholder="Maksimum" value="{{ request('saldo_awal_max') }}">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="nama_kegiatan" id="nama_kegiatan" class="form-control"
                                placeholder="Nama kegiatan" value="{{ request('nama_kegiatan') }}">
                        </div>

                        <div class="col-md-4">
                            <label for="uraian_jenis_barang" class="form-label fw-bold text-blue mb-1">Jenis
                                Barang</label>
                            <input type="text" name="uraian_jenis_barang" id="uraian_jenis_barang"
                        ...
                        <div class="col-md-2 d-flex gap-2">
                            ...
                            <a href="{{ route('aset-lancars.index') }}" class="btn btn-outline-blue w-100 fw-bold">
                                <svg xmlns="http://www.w3.org/2000/svg" class="icon me-1" width="18" height="18"
                                    viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none"
                                    stroke-linecap="round" stroke-linejoin="round">
                                    <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                    ...
                    <table class="table table-vcenter table-nowrap">
                        <thead class="bg-blue text-white">
                            <tr>
                                ...
                                <th rowspan="2" class="align-middle" style="min-width: 180px;">Uraian/Jenis Barang
                                </th>
                                <th colspan="3" class="text-center"
                                    style="border-left: 1px solid rgba(255, 255, 255, 0.3);">Saldo Awal</th>
                                <th colspan="5" class="text-center"
                                    style="border-left: 1px solid rgba(255, 255, 255, 0.3);">Mutasi</th>
                                <th colspan="2" class="text-center"
                                    style="border-left: 1px solid rgba(255, 255, 255, 0.3);">Saldo Akhir</th>
                            ...
                            <tr>
                                ...
                                <th class="text-center" style="min-width: 120px;">Harga Satuan</th>
                                <th class="text-center" style="min-width: 120px;">Nilai Total</th>
                                <!-- Mutasi -->
                                <th class="text-center" style="min-width: 80px;">Tambah</th>
                                <th class="text-center" style="min-width: 110px;">Harga Satuan</th>
                                <th class="text-center" style="min-width: 110px;">Nilai Total</th>
                                <th class="text-center" style="min-width: 80px;">(Kurang)</th>
                                <th class="text-center" style="min-width: 110px;">Nilai Total</th>
                                <!-- Saldo Akhir -->
                                <th class="text-center" style="min-width: 80px;">Unit</th>
                                <th class="text-center" style="min-width: 120px;">Nilai Total</th>
                                ...
                                <tr class="hover-row">
                                    ...
                                    <td>
                                        ...
                                        @if ($aset->uraian_kegiatan && strlen($aset->uraian_kegiatan) > 40)
                                            <small
                                                class="text-muted d-block">{{ Str::limit($aset->uraian_kegiatan, 40) }}</small>
                                        @endif
                                    </td>
                                    <td>
            ...
            @else
                <div class="card-body">
                    <div class="empty py-5">
                        <div class="empty-img">
                            <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-lg text-blue" width="128"
                                height="128" viewBox="0 0 24 24" stroke-width="1" stroke="currentColor"
                                fill="none" stroke-linecap="round" stroke-linejoin="round">
                                <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                                <polyline points="12 3 20 7.5 20 16.5 12 21 4 16.5 4 7.5 12 3"></polyline>
                                <line x1="12" y1="12" x2="20" y2="7.5"></line>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body text-center py-4">
                    <svg xmlns="http://www.w3.org/2000/svg"
                        class="icon icon-tabler icon-tabler-alert-circle mb-2 text-danger icon-lg" width="48"
                    ...
                    <div class="text-muted">
                        Apakah Anda yakin ingin menghapus data aset lancar ini? Data yang sudah dihapus tidak dapat
                        dikembalikan.
                    </div>
                </div>
    ...
    <script>
        $(document).ready(function() {
            function updateExportForm() {
                ...
                const hasFilters = $('#search').val() || $('#rekening_uraian_id').val() || $('#nama_kegiatan')
                    .val() ||
...
@push('page-styles')
    <style>
        ...
        .table thead th {
            ...
            text-transform: uppercase;
            box-shadow: 0 2px 4px rgba(59, 130, 246, 0.1);
            /* Hapus border-radius untuk menghilangkan celah putih */
            border-radius: 0 !important;
        }

        /* Semua header berwarna biru dengan pemisah yang halus */
        .table thead th {
            background: linear-gradient(135deg, var(--blue-primary) 0%, var(--blue-secondary) 100%) !important;
            border-left: 1px solid rgba(255, 255, 255, 0.2);
        }

        /* Pastikan table-responsive tidak memiliki border-radius di bagian atas */
        .table-responsive {
            border-radius: 0 0 var(--border-radius) var(--border-radius);
            overflow-x: auto;
            background: white;
        ...
        /* Styling untuk card yang berisi tabel */
        .card .table-responsive {
            margin: 0;
            border-radius: 0;
        }

        /* Perbaikan untuk baris tabel agar lebih konsisten */
        .table tbody td[style*="background-color: #f8fdff"] {
            background-color: rgba(248, 253, 255, 0.7) !important;
            border-left: 1px solid rgba(59, 130, 246, 0.1);
        }

        .table tbody td[style*="background-color: #f0fdf4"] {
            background-color: rgba(240, 253, 244, 0.7) !important;
            border-left: 1px solid rgba(34, 197, 94, 0.1);
        }

        .table tbody td[style*="background-color: #fffbeb"] {
            background-color: rgba(255, 251, 235, 0.7) !important;
            border-left: 1px solid rgba(245, 158, 11, 0.1);
        }

        /* Perbaikan untuk footer tabel */
        .table tfoot th {
            background: var(--gradient-blue);
            color: var(--blue-dark);
            font-weight: 600;
        ...
        /* Pastikan tidak ada overflow yang menyebabkan celah */
        .card {
            border: none;
            border-radius: var(--border-radius);
            box-shadow: var(--shadow-large);
            background: white;
            overflow: hidden;
            /* Penting untuk menghilangkan celah */
            transition: var(--transition);
        }

        /* Styling untuk header card */
        .card-header.bg-blue-lt {
            background: var(--gradient-blue);
            border: none;
            padding: 1.5rem;
            position: relative;
